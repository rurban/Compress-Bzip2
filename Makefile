...
manifypods : pure_all Bzip2.pm
	@$(POD2MAN) \
	Bzip2.pm \
	$(INST_MAN3DIR)/Compress::Bzip2.$(MAN3EXT)
...
clean ::
	-rm -rf Bzip2.c ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all perlmain.c mon.out core core.*perl.*.? *perl.core so_locations pm_to_blib *~ */*~ */*/*~ *$(OBJ_EXT) *$(LIB_EXT) perl.exe $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def $(BASEEXT).exp
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Compress-Bzip2\" VERSION=\"1,00,0,0\">\n}. qq{\t<TITLE>Compress-Bzip2</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Compress-Bzip2.ppd
