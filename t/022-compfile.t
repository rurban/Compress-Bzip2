...
my $in;
open( $in, "< t/022-sample.txt" );

my $d = bzopen( "t/022-tmp-sample.bz2", "w" );
...
system( 'bzip2 < t/022-sample.txt | od -x > t/022-tmp-reference-bz2.odx' );
system( 'od -x < t/022-tmp-sample.bz2 | diff -c - t/022-tmp-reference-bz2.odx > t/022-tmp-diff.txt' );

ok( ! -s 't/022-tmp-diff.txt', "no differences with bzip2" );
